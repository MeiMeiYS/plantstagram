...
const UploadImg = ({ showUploadImage, setShowUploadImage }) => {
  ...
  useEffect(() => {
    console.log(
      "please make sure this returns true so we can upload image =>",
      preview.startsWith("data:image/")
    );
    if (preview && preview.startsWith("data:image/") && desc.length > 10)
      ...
      <div className="upload-img-UI-container" ref={uploadImgUI}>
        ...
        <div className="upload-img">
          <div className="choose-img">
            ...
            <label htmlFor="upload-img-input" className="select-upload-img-btn">
              {preview ? "Select a different image" : "Select from computer"}
            </label>
            <input
              id="upload-img-input"
              type="file"
